            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{ route('homepage') }}"><img src="assets/front/images/home/logo.png" alt="" /></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            @if (Auth::check())
                                <li><a href="#"><i class="fa fa-user"></i><span>Hello, {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}}</span></a>
                                </li>
